...
public class SimulatorAction extends AbstractAction {
   ...
   * @param accelerator for calling the action without using the mouse at all. See
   *                    https://docs.oracle.com/javase/8/docs/api/index.html for details.
  ...
  public SimulatorAction(Command command, Runnable callback) {
    this(command.name, command.icon, command.tooltip, command.keyEvent, command.accelerator,
        callback);
  }
